...
### 3. Commands
```bash
# UDP flood (65KB packets for 60 seconds)
aegis-stress> attack 1.2.3.4 12345 udp 65507 60
...
# HTTPS GET flood (30 seconds)
aegis-stress> attack 1.2.3.4 443 https 0 30
